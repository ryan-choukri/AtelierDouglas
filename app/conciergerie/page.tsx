    ...
    <div className={styles.site}>
      <header className={styles.navbar}>
        <a
          ...
          href="#accueil"
          aria-label="Maison Hôte, accueil"
        >
          <BrandMark />
          <span>
            <strong>Maison Hôte</strong>
            <small>Conciergerie parisienne</small>
          </span>
        </a>
      ...
      <main>
          ...
          <div className={styles.heroContent}>
            <div className={styles.heroCopy}>
              <p className={styles.eyebrow}>
                Maison Hôte / Paris / Île-de-France
              </p>
              <h1>
                Votre logement reste à vous. <span>Pas sa gestion.</span>
              </h1>
              <p className={styles.heroLead}>
                Prix, messages, ménage, linge et imprévus&nbsp;: nous tenons le
                quotidien de votre location courte durée. Vous gardez les
                décisions et la visibilité.
              </p>
              <div className={styles.heroActions}>
                <a className={styles.primaryButton} href="#estimation">
                  Estimer mon bien <ArrowRight size={18} aria-hidden="true" />
                </a>
                <a className={styles.textButton} href="#gestion">
              ...
              <div className={styles.heroTrust}>
                ...
                <span>
                  Annonces à votre nom · calendrier accessible · aucune dépense
                  importante sans votre accord
                </span>
              </div>
            </div>
        ...
        >
          <p>
            <span>01</span>
            <strong>Vous décidez des dates</strong>
            <small>Le calendrier reste accessible.</small>
          </p>
          <p>
            <span>02</span>
            <strong>Nous connaissons le bien</strong>
            <small>Accès, consignes et points sensibles.</small>
          </p>
          <p>
            <span>03</span>
            <strong>Chaque passage est tracé</strong>
            <small>Ménage, linge, contrôle et incident.</small>
          </p>
          <p>
            <span>04</span>
            <strong>Un doute&nbsp;? On vous appelle.</strong>
            <small>Pas de décision importante dans votre dos.</small>
          </p>
        </section>
        ...
        <section className={styles.comparison} id="gestion">
          <div className={styles.sectionHeading}>
            ...
            <h2>
              Vous gardez le bien.
              <br />
              Nous prenons le quotidien.
            </h2>
            <p>
              La frontière est claire dès le départ&nbsp;: vos décisions d’un
              côté, les opérations de l’autre. Ce qui doit être validé l’est. Ce
              qui doit avancer avance.
            </p>
          </div>
          ...
          <div className={styles.comparisonGrid}>
            <article className={styles.selfManaged}>
              ...
              <ul>
                <li>
                  <X size={15} /> Messages à toute heure
                </li>
                <li>
                  <X size={15} /> Ménages à coordonner
                </li>
                <li>
                  <X size={15} /> Prix à réajuster
                </li>
                <li>
                  <X size={15} /> Petits imprévus à distance
                </li>
                <li>
                  <X size={15} /> Calendriers à synchroniser
                </li>
              </ul>
            </article>
            ...
            <figure className={styles.serviceImage}>
              ...
              />
              <figcaption>
                <span>Contrôle séjour 014</span>Préparation · linge ·
                vérification
              </figcaption>
            </figure>
            ...
            <article className={styles.managed}>
              ...
              <ul>
                <li>
                  <Check size={15} /> Une équipe locale joignable
                </li>
                <li>
                  <Check size={15} /> Un logement suivi entre les séjours
                </li>
                <li>
                  <Check size={15} /> Des voyageurs accompagnés
                </li>
                <li>
                  <Check size={15} /> Une visibilité sur l’activité
                </li>
                <li>
                  <Check size={15} /> Vos périodes personnelles préservées
                </li>
              </ul>
            </article>
          </div>
        ...
        <section className={styles.services} aria-labelledby="operations-title">
          <div className={styles.servicesIntro}>
            ...
            <h2 id="operations-title">
              Entre deux séjours, rien n’est laissé au hasard.
            </h2>
            <p>
              Voici à quoi ressemble une rotation classique. Ce scénario est un
              exemple de fonctionnement, pas une promesse de délai universelle.
            </p>
          </div>
          ...
          <div className={styles.operationBoard}>
            ...
            <aside
              className={styles.operationChecklist}
              aria-label="Exemple de contrôle final"
            >
              <div>
              ...
              <p>
                <Check size={15} /> Linge compté
              </p>
              <p>
                <Check size={15} /> Consommables ajustés
              </p>
              <p>
                <Check size={15} /> Accès testé
              </p>
              <p>
                <Check size={15} /> Photos de fin ajoutées
              </p>
          ...
          <div className={styles.compatibilityNote}>
            ...
            <p>
              ...
              Airbnb, Booking.com et vos calendriers existants peuvent continuer
              à faire partie de votre organisation.
            </p>
            <a href="#estimation">
              Parler de mon organisation <ArrowRight size={17} />
            </a>
          </div>
        </section>
        ...
        <section className={styles.method} id="methode">
          ...
          <div className={styles.methodSteps}>
            <article>
              ...
              <p>
                Accès, couchages, rangement du linge, règlement de copropriété
            ...
            <article>
              ...
              <p>
                Annonce, photographie, prix de départ, livret d’accueil et
                organisation du premier passage.
              </p>
            ...
            <article>
              <span>J+1</span>
              <div>
                <small>En exploitation</small>
                <h3>Premier séjour suivi</h3>
              </div>
              <p>
                Messages, arrivée, départ, ménage et premier retour opérationnel
                sur le logement.
              </p>
        ...
        <section className={styles.properties} id="logements">
          <div className={styles.propertiesHeading}>
            ...
            <p>
              Ces logements et caractéristiques sont des exemples fictifs créés
              pour la démonstration de cette page. Ils illustrent notre
              direction de présentation.
            </p>
          </div>
        ...
        <section className={styles.testimonials} aria-labelledby="report-title">
          <div className={styles.testimonialsHeading}>
            ...
            <h2 id="report-title">
              Voir ce qui s’est passé, sans avoir à le demander.
            </h2>
            <p>
              Le rapport ci-dessous est un scénario de démonstration. Les
              événements et valeurs servent uniquement à montrer le niveau
          ...
          <div className={styles.ownerReport}>
            <article className={styles.reportSheet}>
              <header>
                <div>
                  <span>Rapport propriétaire</span>
                  <strong>JUIN / DÉMO</strong>
                </div>
              ...
              <div className={styles.reportMetrics}>
                <p>
                  <span>Séjours</span>
                  <strong>6</strong>
                  <small>valeur fictive</small>
                </p>
                <p>
                  <span>Nuits occupées</span>
                  <strong>19</strong>
                  <small>valeur fictive</small>
                </p>
                <p>
              ...
              <div className={styles.reportNote}>
                ...
                <p>
                  Le jeu de clés secondaire a été remplacé après validation. Une
                  photo et le justificatif sont joints au suivi d’exemple.
                </p>
              </div>
              <footer>
                Document d’interface fictif — aucun résultat réel n’est
                présenté.
              </footer>
            </article>
            ...
            <article className={styles.activityLog}>
              <header>
                ...
                <small>Exemple de journal</small>
              </header>
              <div>
              ...
              <blockquote>
                “Vous n’avez pas besoin d’être dans la boucle de chaque message.
                Vous devez pouvoir retrouver l’information quand elle compte.”
              </blockquote>
            </article>
          </div>
        </section>
        ...
        <section className={styles.area}>
          <div className={styles.areaCopy}>
            ...
            <p>
              La proximité nous permet de connaître les logements, d’intervenir
              avec bon sens et de construire un réseau de prestataires
              réellement mobilisables.
            </p>
            <div className={styles.localDetails}>
              <p>
                <span>Accès</span>Boîtes à clés, digicodes et remises en main
                propre selon l’adresse.
              </p>
              <p>
                <span>Terrain</span>Stationnement, étages sans ascenseur et
                immeubles anciens anticipés dès la visite.
              </p>
            </div>
            <ul>
              <li>Paris</li>
            ...
            <small>
              Zone indicative de démonstration — l’éligibilité dépend de
          ...
          <div
            ...
            aria-label="Schéma de zone d’intervention autour de Paris"
          >
            <div className={styles.mapRingOne} />
            <div className={styles.mapRingTwo} />
            <span className={styles.mapCenter}>
              <MapPin size={20} />
              Paris
            </span>
        ...
        <section className={styles.faq} id="faq">
          <div className={styles.faqHeading}>
            ...
            <p>
              Une question particulière sur votre logement ? Le premier échange
              sert justement à vérifier que notre fonctionnement vous convient.
            </p>
            <a href="#estimation">
              Poser ma question <ArrowRight size={17} />
            </a>
          </div>
        ...
        <section className={styles.finalEstimate} id="estimation">
          <div className={styles.finalEstimateIntro}>
            ...
            <p>
              Le simulateur donne un premier ordre de grandeur fictif. Pour
              aller plus loin, partagez-nous les vraies caractéristiques du
              bien. Nous vous recontactons pour une estimation contextualisée.
            </p>
            <div className={styles.finalBenefits}>
              <p>
                <Check size={16} /> Estimation sans engagement
              </p>
              <p>
                <Check size={16} /> Échange avec un interlocuteur local
              </p>
              <p>
                <Check size={16} /> Recommandations adaptées au logement
              </p>
            </div>
          </div>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerBrand}>
          ...
          <p>
            Gestion locale de locations courte durée à Paris et en proche
            couronne.
          </p>
        </div>
        ...
        <div className={styles.footerLinks}>
          ...
          <a href="#logements">Les logements</a>
          <a href="#faq">FAQ</a>
        </div>
      ...
      <ProspectCTA
        pageName="conciergerie"
        pageUrl="https://atelierdouglas.fr/conciergerie"
      />
    </div>
  );
}
